...
train_stage=-10
get_egs_stage=-10
affix=_dim600  # 2 layers have dropout with proportion 0.2
decode_iter=
lat_beam=8.0
beam=15.0
...
dir=exp/chain/e2e_xent7L${affix}${topo_affix}${tree_affix}
...
if [ $stage -le 12 ]; then
  ...
  $nnet_block name=prefinal-xent input=tdnn6 dim=$prefinal_dim target-rms=0.5
